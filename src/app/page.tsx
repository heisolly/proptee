    ...
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <main className="relative">
          ...
          {/* 3. Popular Properties Grid (GSAP Horizontal Scroll Inside) */}
          <section>
          ...
          >
            ...
            <span className="absolute right-full mr-4 bg-brand-dark text-white px-3 py-1.5 rounded-lg text-xs font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-lg">
              Chat with us
            </span>
          </Link>
